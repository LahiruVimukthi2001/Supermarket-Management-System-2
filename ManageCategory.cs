    ...
    public partial class ManageCategory : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Con.Open();
                string query = "insert into MCategoryTbl(Category_ID,Category_Name,Description) values('"+CatIdTb.Text +"','"+CatNameTb.Text+"','"+CatDescTb.Text+"')";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Con.Open();
                    string query = "delete from MCategoryTbl where Category_ID = '" + CatIdTb.Text + "' ";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                ...
                else
                {
                    ...
                    Con.Open();
                    string query = "update MCategoryTbl set Category_Name = '" + CatNameTb.Text + "', Description = '" + CatDescTb.Text + "' where Category_ID = '" + CatIdTb.Text + "'; ";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
