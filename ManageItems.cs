    ...
    public partial class ManageItems : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e) 
        {
            ...
            try
            {
                ...
                Con.Open();
                string query = "insert into MItemsTbl(Item_ID,Item_Name,Item_Quantity,Item_Price,Item_Category) values('" + IteId.Text+ "','" +IteName.Text+ "','" +IteQuan.Text+ "','" +ItePri.Text+"','"+IteCate.Text+"')";
