    ...
    public partial class SellingDetails : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Con.Open();
                string query = "insert into SellingTbl(Bill_ID,Item_Name,Item_Price,Quantity,Date) values('" + BId.Text + "','" + IteName.Text + "','"+Pri.Text+"','"+Quant.Text+"','" + DateLbl.Text + "')";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Con.Open();
                    string query = "delete from SellingTbl where Bill_ID= '" + BId.Text+"' ";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Con.Open();
                    string query = "update SellingTbl set Item_Name = '" + IteName.Text+"',Item_Price = '"+Pri.Text+"',Quantity ='"+Quant.Text+"', Date= '"+DateLbl.Text+"'  where Bill_ID= '"+BId.Text+"'; ";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
        ...
        private void AmtIbl_Click(object sender, EventArgs e)
        {
            //rs
        }
